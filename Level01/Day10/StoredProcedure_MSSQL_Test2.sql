...
ALTER PROCEDURE IncreaseSalary

    @p_employee_id INT,

    @p_increment DECIMAL(10,2) ,
	@p_newsal DECIMAL(10,2) OUTPUT
...
DECLARE @inc_salary DECIMAL(10,2);
DECLARE @new_salary DECIMAL(10,2);

SET @inc_salary = 50000;

EXEC IncreaseSalary 1, @inc_salary,@new_salary OUTPUT;
